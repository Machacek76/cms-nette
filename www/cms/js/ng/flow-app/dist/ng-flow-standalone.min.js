...
(function(window, document, undefined) {
    ...
    function FlowFile(flowObj, file) {
        ...
        this.chunkAlt = flowObj.opts.chunkAlt;
        this.chunkDes = flowObj.opts.chunkDes;
        this.chunkAut = flowObj.opts.chunkAut;
        this.chunkNam = flowObj.opts.chunkNam;
        /**
         * Reference to file
         * @type {File}
         */
    ...
    FlowChunk.prototype = {
        ...
        getParams: function() {
            ...
            return {
                ...
                flowChunkAlt: this.fileObj.chunkAlt,
                flowChunkNam: this.fileObj.chunkNam,
                flowChunkDes: this.fileObj.chunkDes,
                flowChunkAut: this.fileObj.chunkAut
            };
        },
        /**
        ...
        test: function() {
            ...
            //this.xhr.open('POST', 'somewhere', true);
            this.xhr.send(data);
        },
        /**
